...
class Option(models.Model):
	...
	height = models.DecimalField(u'Altura', decimal_places=2, max_digits=10, blank=True, null=True, help_text=u"min: 2cm")
	width = models.DecimalField(u'Largura', decimal_places=2, max_digits=10, blank=True, null=True, help_text=u"min: 11cm")
	length = models.DecimalField(u'Tamanho', decimal_places=2, max_digits=10, blank=True, null=True, help_text=u"min: 16cm")
